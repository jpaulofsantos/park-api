...
insert into spaces (id, code, status) values (400, 'AJ13', 'OCCUPIED');
insert into spaces (id, code, status) values (500, 'AK14', 'OCCUPIED');
...
insert into clients_have_spaces (receipt_number, plate, manufacturer, model, color, entry_date, id_client, id_parking_space) values ('20240306-134043', 'OUG-2023', 'VW', 'AMAROK', 'PRATA', '2024-03-05 13:40:43', 2, 400);
insert into clients_have_spaces (receipt_number, plate, manufacturer, model, color, entry_date, id_client, id_parking_space) values ('20240307-134046', 'OUG-2024', 'VW', 'SAVEIRO', 'BRANCO', '2024-03-05 13:40:46', 3, 500);
